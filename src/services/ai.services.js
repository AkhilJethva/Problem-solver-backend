...
const groq = new Groq({ apiKey: process.env.GRAQ_API_KEY });
...
const getResponse = async (prompt) => {
  const chatCompletion = await groq.chat.completions.create({
    ...
    messages: [
      ...
      {
        role: "system",
        content: `Act as an expert in programming languages who has read through many programming advice online for Python, Java, C, and C ++.
